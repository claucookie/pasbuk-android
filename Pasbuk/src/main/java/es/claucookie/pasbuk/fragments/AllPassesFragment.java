...
/**
 * Created by claucookie on 16/03/15.
 */
@EFragment(R.layout.fragment_all_passes)
public class AllPassesFragment extends Fragment implements ListEventListener<PassBookDTO> {


    private static final String TAG = AllPassesFragment.class.getName();
    ...
    private void updateTitle() {
        if (isAdded()) {
            ((MainActivity) getActivity()).updateToolbarTitle(getString(R.string.all_companies));
        }
    }
