	...
	public static class Builder {
		...
		public Builder setEncryptContent(String ivx, String secretKey) {
			...
			try {
				...
				Log.e("SimpleStorageConf", "UnsupportedEncodingException", e);
			}
			...
			try {
				...
				Log.e("SimpleStorageConf", "InvalidKeySpecException", e);
			}
			catch (NoSuchAlgorithmException e) {
				Log.e("SimpleStorageConf", "NoSuchAlgorithmException", e);
			}
